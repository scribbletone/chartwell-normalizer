      ...
      <div className="App">
        ...
        <footer>
          <div className='what'>
            <h5>What is this?</h5>
            <p>
            <a href='https://www.scribbletone.com/typefaces/ff-chartwell' target='_blank' without="true" rel="noopener noreferrer">FF Chartwell</a> only supports values from 0-100. This can be a problem if your data has values that do not fit within this range. To get around this, you can <a href='https://en.wikipedia.org/wiki/Normalization_(statistics)' target="_blank" without="true" rel="noopener noreferrer">normalize</a> your data. Essentially this scales the data to fit within the acceptable range and preserves the relationships between each value.
            </p>
            <p>
